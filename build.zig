...
pub fn build(b: *std.Build) void {
    ...
    sdl3.addCSourceFiles(.{ .files = &generic_src_files });
    sdl3.defineCMacro("SDL_USE_BUILTIN_OPENGL_DEFINITIONS", "1");
    sdl3.linkLibC();
    switch (t.os.tag) {
        .windows => {
            sdl3.addCSourceFiles(.{ .files = &windows_src_files });
        ...
        .macos => {
            sdl3.addCSourceFiles(.{ .files = &darwin_src_files });
            sdl3.addCSourceFiles(.{
                .files = &objective_c_src_files,
                .flags = &.{"-fobjc-arc"},
            });
            sdl3.linkFramework("OpenGL");
            sdl3.linkFramework("Metal");
            sdl3.linkFramework("CoreVideo");
            sdl3.linkFramework("Cocoa");
            sdl3.linkFramework("IOKit");
            sdl3.linkFramework("ForceFeedback");
            sdl3.linkFramework("Carbon");
            sdl3.linkFramework("CoreAudio");
            sdl3.linkFramework("AudioToolbox");
            sdl3.linkFramework("AVFoundation");
            sdl3.linkFramework("Foundation");
        },
        .emscripten => {
            sdl3.defineCMacro("__EMSCRIPTEN_PTHREADS__ ", "1");
            sdl3.defineCMacro("USE_SDL", "2");
            sdl3.addCSourceFiles(.{ .files = &emscripten_src_files });
            if (b.sysroot == null) {
            ...
            sdl3.addIncludePath(b.path(cache_include));
        },
        else => {},
    }
    ...
    if (use_pregenerated_config) {
        ...
        sdl3.installHeadersDirectory(b.path("include/build_config"), "SDL3", .{});
        sdl3.addCSourceFiles(.{ .files = render_driver_sw.src_files });
    } else {
        ...
        switch (t.os.tag) {
            .linux => {
                ...
                applyOptions(b, sdl3, &files, config_header, &linux_options);
            },
            else => {},
        }

        sdl3.addCSourceFiles(.{ .files = files.toOwnedSlice() catch @panic("OOM") });
        sdl3.addConfigHeader(config_header);
        sdl3.installConfigHeader(config_header);
        ...
        sdl3.addConfigHeader(revision_header);
        sdl3.installConfigHeader(revision_header);
    }
    sdl3.installHeadersDirectory(b.path("include/SDL3"), "SDL3", .{});
...
const linux_src_files = [_][]const u8{ "src/core/linux/SDL_dbus.c", "src/core/linux/SDL_evdev.c", "src/core/linux/SDL_evdev_capabilities.c", "src/core/linux/SDL_evdev_kbd.c", "src/core/linux/SDL_fcitx.c", "src/core/linux/SDL_ibus.c", "src/core/linux/SDL_ime.c", "src/core/linux/SDL_sandbox.c", "src/core/linux/SDL_system_theme.c", "src/core/linux/SDL_threadprio.c", "src/core/linux/SDL_udev.c", "src/haptic/linux/SDL_syshaptic.c", "src/hidapi/linux/hid.c", "src/joystick/linux/SDL_sysjoystick.c", "src/power/linux/SDL_syspower.c", "src/video/wayland/SDL_waylandclipboard.c", "src/video/wayland/SDL_waylanddatamanager.c", "src/video/wayland/SDL_waylanddyn.c", "src/video/wayland/SDL_waylandevents.c", "src/video/wayland/SDL_waylandkeyboard.c", "src/video/wayland/SDL_waylandmessagebox.c", "src/video/wayland/SDL_waylandmouse.c", "src/video/wayland/SDL_waylandopengles.c", "src/video/wayland/SDL_waylandshmbuffer.c", "src/video/wayland/SDL_waylandtouch.c", "src/video/wayland/SDL_waylandvideo.c", "src/video/wayland/SDL_waylandvulkan.c", "src/video/wayland/SDL_waylandwindow.c", "src/video/x11/SDL_x11clipboard.c", "src/video/x11/SDL_x11dyn.c", "src/video/x11/SDL_x11events.c", "src/video/x11/SDL_x11framebuffer.c", "src/video/x11/SDL_x11keyboard.c", "src/video/x11/SDL_x11messagebox.c", "src/video/x11/SDL_x11modes.c", "src/video/x11/SDL_x11mouse.c", "src/video/x11/SDL_x11opengl.c", "src/video/x11/SDL_x11opengles.c", "src/video/x11/SDL_x11pen.c", "src/video/x11/SDL_x11shape.c", "src/video/x11/SDL_x11touch.c", "src/video/x11/SDL_x11video.c", "src/video/x11/SDL_x11vulkan.c", "src/video/x11/SDL_x11window.c", "src/video/x11/SDL_x11xfixes.c", "src/video/x11/SDL_x11xinput2.c", "src/video/x11/xsettings-client.c", "src/video/x11/edid-parse.c" };
...
const emscripten_src_files = [_][]const u8{ "src/audio/emscripten/SDL_emscriptenaudio.c", "src/filesystem/emscripten/SDL_sysfilesystem.c", "src/joystick/emscripten/SDL_sysjoystick.c", "src/locale/emscripten/SDL_syslocale.c", "src/misc/emscripten/SDL_sysurl.c", "src/power/emscripten/SDL_syspower.c", "src/video/emscripten/SDL_emscriptenevents.c", "src/video/emscripten/SDL_emscriptenframebuffer.c", "src/video/emscripten/SDL_emscriptenmouse.c", "src/video/emscripten/SDL_emscriptenopengles.c", "src/video/emscripten/SDL_emscriptenvideo.c", "src/timer/unix/SDL_systimer.c", "src/loadso/dlopen/SDL_sysloadso.c", "src/audio/disk/SDL_diskaudio.c", "src/render/opengles2/SDL_render_gles2.c", "src/render/opengles2/SDL_shaders_gles2.c", "src/sensor/dummy/SDL_dummysensor.c", "src/thread/pthread/SDL_syscond.c", "src/thread/pthread/SDL_sysmutex.c", "src/thread/pthread/SDL_sysrwlock.c", "src/thread/pthread/SDL_syssem.c", "src/thread/pthread/SDL_systhread.c", "src/thread/pthread/SDL_systls.c" };
